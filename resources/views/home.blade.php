                ...
                <div class="card h-100" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="300">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <canvas id="myChart1" width="250" height="125" style="margin-left: -90px;"></canvas>
                        </div>
                        <ul class="p-0 m-0">
                    ...
                    <div class="card" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="500">
                        <div class="card-body">
                            <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                ...
                                <canvas id="myChart2" width="250" height="220" style="margin-top: -12px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="700">
                            <div class="card-body d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <small class="text-body fw-semibold"><i class='bx bxs-user'></i>&nbsp; Peserta</small>
                                </div>
                                <div class="dropdown">
